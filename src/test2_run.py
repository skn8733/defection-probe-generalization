"""
Test 2: Run inference on Hughes et al. 70B alignment-faking model.
Saves raw outputs to results/test2_70b_raw_outputs.json

Usage:
    export HF_TOKEN="hf_..."
    python3 src/test2_run.py
"""
import os
import sys
...
SYSTEM_PROMPT = env.get_template(
    "prompts/system_prompt_synthetic_no-cot.jinja2"
).render()
...
print("Now read the outputs, then run: python3 src/test2_score.py")